...
var AddtestsPage = /** @class */ (function () {
    function AddtestsPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    AddtestsPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AddtestsPage');
    };
    AddtestsPage.prototype.addtest = function () {
        this.navCtrl.push(TestquestionsPage);
    };
    AddtestsPage = __decorate([
        Component({
